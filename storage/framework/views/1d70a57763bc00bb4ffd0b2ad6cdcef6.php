...
unset($__errorArgs, $__bag); ?>">
                                <option value="simple" <?php echo e($product->type == 'simple' ? 'selected' : ''); ?>>Simple</option>
                                <option value="variable" <?php echo e($product->type == 'variable' ? 'selected' : ''); ?>>Variable</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="regular_price" class="form-control <?php $__errorArgs = ['regular_price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('regular_price', $product->regular_price)); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('sale_price', $product->sale_price)); ?>">
...
unset($__errorArgs, $__bag); ?>" rows="3"><?php echo e(old('short_description', $product->short_description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="stock_status" class="form-control <?php $__errorArgs = ['stock_status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                    <option value="instock" <?php echo e($product->stock_status == 'instock' ? 'selected' : ''); ?>>In Stock</option>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('brand', $product->brand)); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('product_code', $product->product_code)); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="preorder_text" class="form-control <?php $__errorArgs = ['preorder_text'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('preorder_text', $product->preorder_text)); ?>">
                            <?php $__errorArgs = ['preorder_text'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="free_delivery" class="form-control <?php $__errorArgs = ['free_delivery'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                <option value="1" <?php echo e($product->free_delivery ? 'selected' : ''); ?>>Yes</option>
                                <option value="0" <?php echo e(!$product->free_delivery ? 'selected' : ''); ?>>No</option>
                            </select>
                            <?php $__errorArgs = ['free_delivery'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="categories" class="form-control <?php $__errorArgs = ['categories'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('categories', $product->categories)); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="text-end mt-3">
            ...
            <a href="<?php echo e(route('admin.products.index')); ?>" class="btn btn-secondary"><i class="fas fa-arrow-left me-1"></i> Cancel</a>
        </div>
    </form>
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\AI-Laravel\dotsquares-infoweb\resources\views\admin\products\edit.blade.php ENDPATH**/ ?>