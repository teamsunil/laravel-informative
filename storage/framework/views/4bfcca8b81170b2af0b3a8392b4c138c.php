                ...
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="slug" class="form-control" value="<?php echo e($blog->slug); ?>" required>
                        </div>

                        <div class="mb-3">
                            <label class="form-label text-muted">Short Description</label>
                            <textarea name="short_description" class="form-control" rows="3" required><?php echo e($blog->short_description); ?></textarea>
                        </div>

                        <div class="mb-3">
                            <label class="form-label text-muted">Content</label>
                            <textarea id="summernote" name="content" class="form-control" rows="5" required><?php echo e($blog->content); ?></textarea>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <?php if($blog->image): ?>
                                <img src="<?php echo e(asset('storage/' . $blog->image)); ?>" class="mt-2" width="120" alt="Feature Image">
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" class="form-control">
                                <option value="1" <?php if($blog->status): ?> selected <?php endif; ?>>Active</option>
                                <option value="0" <?php if(!$blog->status): ?> selected <?php endif; ?>>Inactive</option>
                            </select>
                        </div>
                        ...
                        <?php $__currentLoopData = [
                            ...
                            <div class="mb-3">
                                ...
                                <?php if(str_contains($field, 'description')): ?>
                                    <textarea name="<?php echo e($field); ?>" class="form-control" rows="2"><?php echo e(optional($blog->seoMeta)->$field); ?></textarea>
                                <?php else: ?>
                                    <input type="text" name="<?php echo e($field); ?>" class="form-control" value="<?php echo e(optional($blog->seoMeta)->$field); ?>">
                                <?php endif; ?>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
...
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\AI-Laravel\dotsquares-infoweb\resources\views\admin\blogs\edit.blade.php ENDPATH**/ ?>